...
st.title("Dashboard - Student Marks Data")
...
fig_1 = px.line(df[df['Sex'] == species], x="Marks(out of 100)")
col1.plotly_chart(fig_1, use_container_width=True)

fig_2 = px.bar(df[df['Sex'] == species], y="Marks(out of 100)")
col2.plotly_chart(fig_2, use_container_width=True)

fig_3 = px.scatter(df[df['Sex'] == species], y="Marks(out of 100)")
